    ...
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[72px] flex-col border-r border-sidebar-border bg-[linear-gradient(180deg,hsl(var(--sidebar-bg))_0%,hsl(220_42%_14%)_100%)] shadow-[24px_0_60px_hsl(222_58%_5%_/_0.22)]">
      ...
      <div className="relative px-2 pb-3">
        <div className="group relative">
          ...
          >
            <div className={cn("relative flex h-9 w-9 items-center justify-center bg-gradient-to-br from-primary via-accent to-info shadow-[0_12px_28px_hsl(222_58%_5%_/_0.28)]", RADIUS.lg)}>
              <span className={cn("font-bold text-primary-foreground", TEXT.meta)}>JD</span>
            </div>
          </button>

          <div className={cn("pointer-events-none absolute left-full bottom-0 z-50 ml-3 w-56 translate-x-2 border border-sidebar-border bg-[linear-gradient(180deg,hsl(var(--sidebar-bg)_/_0.98),hsl(220_40%_13%_/_0.98))] p-4 opacity-0 shadow-[0_24px_64px_hsl(222_58%_5%_/_0.32)] transition-all duration-200 group-hover:pointer-events-auto group-hover:translate-x-0 group-hover:opacity-100", RADIUS.lg)}>
            <div className="flex items-start gap-3">
              <div className={cn("flex h-11 w-11 shrink-0 items-center justify-center bg-gradient-to-br from-primary via-accent to-info", RADIUS.lg)}>
                <span className={cn("font-bold text-primary-foreground", TEXT.body)}>JD</span>
              </div>
              <div className="min-w-0">
                <p className="truncate text-sm font-semibold text-sidebar-foreground">John Doe</p>
                <p className={cn("mt-0.5 font-semibold uppercase tracking-[0.16em] text-sidebar-muted", TEXT.meta)}>admin</p>
                <p className={cn("mt-2 leading-5 text-sidebar-muted", TEXT.meta)}>Backend-ready workspace</p>
              </div>
            </div>
          </div>
        </div>
