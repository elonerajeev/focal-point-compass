...
import { exportReportsAsCsv, openPrintableReport } from "@/lib/export";
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="premium-hover inline-flex items-center gap-2 rounded-full border border-border/70 bg-secondary/35 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-foreground"
            >
            ...
            <button
              type="button"
              onClick={() => openPrintableReport(reports)}
              className="premium-hover inline-flex items-center gap-2 rounded-full border border-border/70 bg-primary px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-primary-foreground"
            >
